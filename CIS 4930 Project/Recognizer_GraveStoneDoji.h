...
// This class recognizes the GraveStoneDoji pattern
public ref class Recognizer_GraveStoneDoji : Recognizer
{
	public:

	/// <summary>
	/// Constructor for the Recognizer_GraveStoneDoji class
	/// </summary>
	Recognizer_GraveStoneDoji();

	/// <summary>
	/// Overrides the Recognize function in the base class to recognize the GraveStoneDoji pattern
	/// </summary>

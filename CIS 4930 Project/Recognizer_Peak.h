...
// This class recognizes the Peak pattern
public ref class Recognizer_Peak : Recognizer
{
	public:

	/// <summary>
	/// Constructor for the Recognizer_Peak class
	/// </summary>
	Recognizer_Peak();

	/// <summary>
	/// Overrides the Recognize function in the base class to recognize the Peak pattern
	/// </summary>

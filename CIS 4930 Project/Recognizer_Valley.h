...
// This class recognizes the Valley pattern
public ref class Recognizer_Valley : Recognizer
{
	public:

	/// <summary>
	/// Constructor for the Recognizer_Valley class
	/// </summary>
	Recognizer_Valley();

	/// <summary>
	/// Overrides the Recognize function in the base class to recognize the Valley pattern
	/// </summary>
